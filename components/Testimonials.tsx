        ...
        <div className="overflow-hidden rounded-2xl">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="relative bg-neutral-900/50 border border-neutral-800 rounded-2xl p-8 md:p-12"
            >
              <Quote className="absolute top-6 right-6 text-purple-500/20" size={40} />
              
              <div className="relative z-10">
                <p className="text-neutral-300 text-lg md:text-xl leading-relaxed mb-8 italic text-center max-w-3xl mx-auto">
