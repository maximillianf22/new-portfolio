...
interface ProjectCardProps {
    project: ProjectItem;
    embed?: boolean; // when true and link exists, render iframe preview
}

const ROTATION_RANGE = 20; // Degrees
const HALF_ROTATION_RANGE = ROTATION_RANGE / 2;

export const ProjectCard: React.FC<ProjectCardProps> = ({ project, embed = false }) => {
             ...
             <div className="bg-neutral-900/95 backdrop-blur-xl border border-white/10 p-5 rounded-2xl shadow-2xl translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500 ease-out">
                <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="flex gap-2 pointer-events-auto">
                        {project.duration && (
                          <span className="px-2 py-1 text-[10px] font-mono bg-white/10 border border-white/10 rounded text-neutral-300">
