...
const ExperienceItem: React.FC<{ exp: ExperienceData; index: number; lang: 'en' | 'es' }> = ({ exp, index, lang }) => {
  return (
    <BlurFade delay={index * 0.05}>
      <div className="relative pl-16 group">
        ...
        <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between mb-2">
          ...
          <span className="font-mono text-sm text-neutral-500 whitespace-nowrap">{exp.dates}</span>
        </div>
...
export const Experience: React.FC<ExperienceProps> = ({ experience, lang }) => {
    ...
    <section className="py-24 max-w-4xl mx-auto px-4" ref={ref}>
      <BlurFade>
        <h2 className="text-3xl font-bold mb-16 text-white/90">
          {lang === 'en' ? "Experience" : "Experiencia Profesional"}
        </h2>
      </BlurFade>
