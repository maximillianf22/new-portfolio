  ...
  return (
    <section className="py-24 px-4 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-4 auto-rows-[200px]">
        ...
        <BlurFade
          delay={0.1}
          className="md:col-span-2 row-span-2 relative group overflow-hidden rounded-3xl border border-neutral-800 bg-neutral-900/30 p-8 flex flex-col justify-between hover:bg-neutral-900/50 transition-colors duration-500"
        >
          <div className="z-10">
        ...
        <BlurFade
          delay={0.2}
          className="md:col-span-1 row-span-1 rounded-3xl border border-neutral-800 bg-neutral-900/30 p-6 flex flex-col justify-between relative overflow-hidden group"
        >
        ...
        <BlurFade
          delay={0.3}
          className="md:col-span-1 row-span-1 rounded-3xl border border-neutral-800 bg-neutral-900/30 overflow-hidden relative"
        >
          <iframe
        ...
        <BlurFade
          delay={0.4}
          className="md:col-span-2 lg:col-span-2 row-span-1 rounded-3xl border border-neutral-800 bg-neutral-900/30 overflow-hidden flex flex-col justify-center relative group"
        >
          ...
          <div className="flex w-full overflow-hidden">
            <div className="flex animate-scroll whitespace-nowrap gap-8 items-center py-4 px-4">
              {techStack.map((tech, i) => (
                <div
                  key={i}
                  className="flex items-center gap-2 text-neutral-400 group-hover:text-white transition-colors"
                >
