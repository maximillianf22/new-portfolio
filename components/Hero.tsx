...
export const Hero: React.FC<HeroProps> = ({ name, headline, subHeadline, lang, avatar }) => {
  const [mousePosition, setMousePosition] = useState({ x: 0, y: 0 });
  const [textIndex, setTextIndex] = useState(0);
  
  const words = lang === 'en' 
    ? ["Next.js Architect", "AI Engineering", "UX Obsessed", "Performance First"]
    : ["Arquitecto Next.js", "Ingeniería IA", "Obsesionado con UX", "Rendimiento Primero"];
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 text-center lg:text-left order-2 lg:order-1">
            ...
            >
              ...
              {lang === 'en' ? "Personal Portfolio 2025" : "Portafolio Personal 2025"}
            </motion.div>
            ...
            >
              <div className="flex items-center gap-4 text-neutral-400">
                <Command size={22} className="group-hover:text-purple-400 transition-colors" />
              ...
              <div className="flex gap-2 opacity-50">
                 <div className="px-2 py-1 rounded-md bg-neutral-800 text-[10px] font-mono text-neutral-400 border border-neutral-700">CMD+K</div>
              </div>
            </motion.div>
            ...
            >
               <span>{lang === 'en' ? "Scroll to explore" : "Desliza para explorar"}</span>
          ...
          <div className="flex-1 relative w-full max-w-[480px] order-1 lg:order-2 perspective-1000">
             ...
             >
                ...
                <div className="absolute bottom-6 left-6 right-6 p-5 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-xl flex items-center justify-between shadow-lg">
                    <div>
                        ...
                        <p className="text-neutral-300 text-xs font-medium tracking-wide">Frontend Architect</p>
                    </div>
             ...
             >
                ...
                <div>
                   <p className="text-[10px] text-neutral-400 font-bold uppercase tracking-wider">Experience</p>
             ...
             <div className="absolute -bottom-10 -left-10 w-64 h-64 bg-cyan-600/20 rounded-full blur-[80px] pointer-events-none -z-10 animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
          </div>
