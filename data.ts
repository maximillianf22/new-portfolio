...
export const data: AppData = {
  ...
  "spanish": {
    ...
    "summary": "Ingeniero de Software y Líder Técnico con 10 años de experiencia construyendo aplicaciones web escalables, especializado en Arquitectura Frontend. Mi enfoque combina experiencia técnica profunda (React/Vue) con pensamiento de producto y principios de diseño centrado en el usuario, traduciendo requisitos complejos de negocio en soluciones técnicas elegantes. Valoro la claridad en la documentación y el intercambio de conocimiento como base para el éxito del equipo.",
    "experience": [
      {
    ...
    "skills": {
      "Frontend Architecture": "Next.js, React, Vue, Nuxt, TypeScript, Turborepo",
  ...
  "projects": [
    ...
    },
    {
      ...
      "solution": "Architected a scalable frontend from scratch, leading a squad of 16 people (developers, QA analysts, designers) to replace the legacy system.",
      "impact": [
    ...
    },
    {
      ...
      "description": "Integrated logistics platform redesign and modernization, transforming legacy systems into a modern React/TypeScript architecture.",
